            ...
            <form onSubmit={submit} className='mt-8 grid grid-cols-6 gap-6'>
              ...
              {canResetPassword &&
                <Link
                  ...
                  className='col-span-4 text-end text-sm font-semibold text-blue-600'
                >
              ...
              <button
                ...
                <span className='absolute inset-0 translate-x-0 translate-y-0 bg-yellow-300
                  transition-transform group-hover:translate-y-1.5 group-hover:translate-x-1.5'></span>
                <span className='relative inline-block border-2 border-current px-6 py-2 md:px-8
                  md:py-3 text-sm font-bold uppercase tracking-widest text-center w-full'
                >
                  Iniciar Sesion
                </span>
              </button>
